...
import { Stack, Container, Typography, Box, Button, SvgIcon } from "@mui/material";
import overlay from "../../assets/overlay_1.svg";
import hero from "../../assets/space.jpeg";
// components
            ...
            <StyledRoot>
                <Container component={MotionContainer}>
                    <StyledContent>
                        ...
                        <Stack spacing={3} display="inline-flex" direction="row" sx={{ color: "common.white" }}>
                            <TextAnimate text="Portfolio" />
                            <TextAnimate text="&" />
                            <TextAnimate text="Resume" />
                        </Stack>
